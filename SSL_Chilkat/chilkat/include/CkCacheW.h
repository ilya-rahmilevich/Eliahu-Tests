...
bool SaveTextDt(const wchar_t *w1,CkDateTime &expire,const wchar_t *w2,const wchar_t *w3);
...
bool SaveToCacheDt(const wchar_t *w1,CkDateTime &expire,const wchar_t *w2,CkByteData &data);
...
bool UpdateExpirationDt(const wchar_t *w1,CkDateTime &dt);

...
CkEmailBundleW *FetchMultiple(const CkStringArray *uidlArray);
CkEmailBundleW *FetchMultiple(const CkStringArray &uidlArray);
CkEmailBundleW *FetchMultipleHeaders(const CkStringArray *uidlArray,long numBodyLines);
CkEmailBundleW *FetchMultipleHeaders(const CkStringArray &uidlArray,long numBodyLines);
CkStringArrayW *FetchMultipleMime(const CkStringArray *uidlArray);
CkStringArrayW *FetchMultipleMime(const CkStringArray &uidlArray);
...
CkEmailW *GetFullEmail(const CkEmail *email);
CkEmailW *GetFullEmail(const CkEmail &email);
...
#endif
#ifndef WINCE
bool SendQ2(const CkEmail *email,const wchar_t *w1);
#endif
#ifndef WINCE
bool SendQ2(const CkEmail &email,const wchar_t *w1);
#endif
...
bool SshAuthenticatePk(bool bSmtp,const wchar_t *w1,CkSshKey &privateKey);
...
CkStringArrayW *TransferMultipleMime(const CkStringArray *uidlArray);
CkStringArrayW *TransferMultipleMime(const CkStringArray &uidlArray);
...
const wchar_t *renderToMime(const CkEmail &email);

...
bool SetFileTimes(const wchar_t *w1,CkDateTime &create,CkDateTime &lastAccess,CkDateTime &lastModified);
bool SetLastModified(const wchar_t *w1,CkDateTime &lastModified);

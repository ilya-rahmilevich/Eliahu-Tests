...
CkHttpResponseW *PostUrlEncoded(const wchar_t *w1,CkHttpRequest &req);
...
CkHttpResponseW *SynchronousRequest(const wchar_t *w1,long port,bool ssl,const CkHttpRequest &req);

...
CkXmlW *SearchAllForContent(const CkXml *after,const wchar_t *w1);
CkXmlW *SearchAllForContent(const CkXml &after,const wchar_t *w1);
bool SearchAllForContent2(const CkXml *after,const wchar_t *w1);
bool SearchAllForContent2(const CkXml &after,const wchar_t *w1);
CkXmlW *SearchForAttribute(const CkXml *after,const wchar_t *w1,const wchar_t *w2,const wchar_t *w3);
CkXmlW *SearchForAttribute(const CkXml &after,const wchar_t *w1,const wchar_t *w2,const wchar_t *w3);
bool SearchForAttribute2(const CkXml *after,const wchar_t *w1,const wchar_t *w2,const wchar_t *w3);
bool SearchForAttribute2(const CkXml &after,const wchar_t *w1,const wchar_t *w2,const wchar_t *w3);
CkXmlW *SearchForContent(const CkXml *after,const wchar_t *w1,const wchar_t *w2);
CkXmlW *SearchForContent(const CkXml &after,const wchar_t *w1,const wchar_t *w2);
bool SearchForContent2(const CkXml *after,const wchar_t *w1,const wchar_t *w2);
bool SearchForContent2(const CkXml &after,const wchar_t *w1,const wchar_t *w2);
CkXmlW *SearchForTag(const CkXml *after,const wchar_t *w1);
CkXmlW *SearchForTag(const CkXml &after,const wchar_t *w1);
bool SearchForTag2(const CkXml *after,const wchar_t *w1);
bool SearchForTag2(const CkXml &after,const wchar_t *w1);

...
bool AuthenticatePk(const wchar_t *w1,CkSshKey &privateKey);
bool AuthenticatePw(const wchar_t *w1,const wchar_t *w2);
bool AuthenticatePwPk(const wchar_t *w1,const wchar_t *w2,CkSshKey &privateKey);
...
bool SetCreateDt(const wchar_t *w1,bool bIsHandle,CkDateTime &createTime);
bool SetCreateTime(const wchar_t *w1,bool bIsHandle,SYSTEMTIME &createTime);
bool SetLastAccessDt(const wchar_t *w1,bool bIsHandle,CkDateTime &createTime);
bool SetLastAccessTime(const wchar_t *w1,bool bIsHandle,SYSTEMTIME &lastAccessTime);
bool SetLastModifiedDt(const wchar_t *w1,bool bIsHandle,CkDateTime &createTime);

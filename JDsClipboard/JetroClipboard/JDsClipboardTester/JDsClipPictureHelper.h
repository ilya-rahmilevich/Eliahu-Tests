...
/////////////////////////////////////
	CJDsClipPictureHelper(IPicture* pPix = NULL) : m_pPix(pPix)
	{
		m_pBuffer = NULL;
	}
	...
	CJDsClipPictureHelper<t_bManaged>& operator=(IPicture* pPix)
	{
		m_pPix = pPix;
		return *this;
	}
...
///////////////////////////
	...
	BOOL Copy(HWND hWnd)
	{
		...
		if (::OpenClipboard(NULL))
		{
			...
			case PICTYPE_ICON:
				{
					HBITMAP hCopy = BitmapFromIconCursor((HICON)GetHandle(), hWnd);
...
typedef CJDsClipPictureHelper<false> CWTLIPictureHandle;
typedef CJDsClipPictureHelper<true> CWTLIPicture;
